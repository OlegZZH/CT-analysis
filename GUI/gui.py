...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        videoplayer = MediaPlayer(self.ui)
        self.ui.pushButton.clicked.connect(videoplayer.openFile)
        self.ui.pushButton_3.clicked.connect(videoplayer.play)
        self.ui.actionOpen.triggered.connect(videoplayer.openFile)
        ...
        self.ui.mediaPlayer.positionChanged.connect(videoplayer.positionChanged)
    ...
    def show_set(self, win):
        ...
        :param win:Від цого параметру залежить чи буде показуватись вікно
        :return:
        """
        win.show()
